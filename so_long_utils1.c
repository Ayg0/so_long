...
/*   Updated: 2022/02/10 17:03:48 by ted-dafi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	gl->s.c[1].ig = gl->xpm_image(gl->mlx, "xpms/c1.xpm",
			&gl->nu.ps, &gl->nu.ps);
	gl->s.c[2].ig = gl->xpm_image(gl->mlx, "xpms/c2.xpm",
			&gl->nu.ps, &gl->nu.ps);
	gl->s.c[3].ig = gl->xpm_image(gl->mlx, "xpms/c3.xpm",
			&gl->nu.ps, &gl->nu.ps);
	gl->s.c[4].ig = gl->xpm_image(gl->mlx, "xpms/c4.xpm",
			&gl->nu.ps, &gl->nu.ps);
	gl->s.c[5].ig = gl->xpm_image(gl->mlx, "xpms/c5.xpm",
			&gl->nu.ps, &gl->nu.ps);
}
...
void	init_data(t_data *gl)
{
	...
	init_coins(gl);
	gl->s.p[1].ig = gl->xpm_image(gl->mlx, "xpms/p.xpm",
			&gl->nu.ps, &gl->nu.ps);
	gl->s.p[2].ig = gl->xpm_image(gl->mlx, "xpms/p2.xpm",
			&gl->nu.ps, &gl->nu.ps);
	gl->s.m.ig = gl->xpm_image(gl->mlx, "xpms/m.xpm", &gl->nu.ps, &gl->nu.ps);
	gl->s.e.ig = gl->xpm_image(gl->mlx, "xpms/n.xpm", &gl->nu.ps, &gl->nu.ps);
	gl->s.ex.ig = gl->xpm_image(gl->mlx, "xpms/e.xpm", &gl->nu.ps, &gl->nu.ps);
}
